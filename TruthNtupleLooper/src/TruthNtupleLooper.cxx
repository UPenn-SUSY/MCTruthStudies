...
// -----------------------------------------------------------------------------
TruhtNtupleLooper::TruhtNtupleLooper(TTree *tree) : fChain(0) 
{
...
TruhtNtupleLooper::~TruhtNtupleLooper()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TruhtNtupleLooper::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TruhtNtupleLooper::LoadTree(Long64_t entry)
{
...
void TruhtNtupleLooper::Init(TTree *tree)
{
...
Bool_t TruhtNtupleLooper::Notify()
{
...
void TruhtNtupleLooper::Show(Long64_t entry)
{
...
Int_t TruhtNtupleLooper::Cut(Long64_t entry)
{
...
#endif // #ifdef TruhtNtupleLooper_cxx
void TruhtNtupleLooper::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L TruhtNtupleLooper.C
//      Root > TruhtNtupleLooper t
